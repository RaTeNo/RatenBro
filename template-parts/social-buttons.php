...
<?php
    $social_buttons = apply_filters( 'root_social_share_buttons', array(
            'vk', 'fb', 'twitter', 'ok', 'gp', 'whatsapp', 'viber', 'telegram', // 'linkedin', 'reddit', 'pinterest',
    ) );
?>
...
<span class="b-share__ico b-share__fb js-share-link" data-uri="http://www.facebook.com/sharer.php?u=<?php echo urlencode(get_the_permalink()) ?>"></span>
<?php elseif ( $social_button == 'vk' ) : ?>
<span class="b-share__ico b-share__vk js-share-link" data-uri="http://vk.com/share.php?url=<?php echo urlencode(get_the_permalink()) ?>"></span>
<?php elseif ( $social_button == 'twitter' ) : ?>
<span class="b-share__ico b-share__tw js-share-link" data-uri="http://twitter.com/share?text=<?php echo urlencode(get_the_title()) ?>&url=<?php echo urlencode(get_the_permalink()) ?>"></span>
